<template>
  <div class="top-bar">
    ...
    <div class="text-container">
      <div class="main-text">TOP 10 FILIPINO</div>
      <div class="sub-text">Daniel Martinez</div>
    </div>
    ...
    <div class="icons-container">
      ...
      <button class="icon-button">
        <svg width="36" height="35" viewBox="0 0 36 35" fill="none">
          <path fill="#222222" d="M34.2691 31.9592C34.8839 31.8447 35.2451 31.1982 34.9525 30.6455C33.7726 28.4175 31.7068 26.4586 28.9806 25.0038C25.8165 23.3153 21.9397 22.4 17.9514 22.4C13.9632 22.4 10.0864 23.3153 6.92229 25.0038C4.19605 26.4586 2.1302 28.4175 0.950377 30.6455C0.657711 31.1982 1.01894 31.8447 1.63375 31.9592L10.6236 33.6345C15.4671 34.5371 20.4357 34.5371 25.2793 33.6345L34.2691 31.9592Z"/>
          <circle cx="17.2514" cy="9.8" r="9.8" fill="#222222"/>
        </svg>
      </button>
    </div>
  </div>
